...
public class DBUtil {
    // 插入数据并返回生成的ID
    public static int insertAndGetId(String tableName, Map<String, Object> valueMap) throws SQLException {
        // 生成SQL语句
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306", "root", "Zya20040219");
            ...
            for (int j = 0; j < bindArgs.length; j++) {
                pstmt.setObject(j + 1, bindArgs[j]);
            }
